        ...
        <div class="flex flex-col gap-2">
            ...
            : issue.labels[1] === 'enhancement'
                ...
                : issue.labels[1] === 'good first issue'
                    ...
                    <p class="py-6 text-slate-600 leading-relaxed border-b border-slate-100">
                        ${issue.description}
                    </p>
...
const showIssues = (issues) => {
    ...
    issues.forEach(issue => {
        ...
        issueCard.innerHTML = `
            <div onclick="loadWordDetail(${issue.id})" class="card-body bg-white rounded-xl border-t-3 ${issue.status === 'open' ? 'border-t-green-600' : 'border-t-purple-600'} shadow-sm p-4 space-y-3">
